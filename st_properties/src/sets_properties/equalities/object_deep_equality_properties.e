note
	description: "Object that checks whether the properties verified within set theory hold for an implementation of {STS_OBJECT_DEEP_EQUALITY}"
	author: "Rosivaldo F Alves"
	date: "$Date$"
	revision: "$Revision$"

class
	OBJECT_DEEP_EQUALITY_PROPERTIES [A, EQ -> STS_OBJECT_DEEP_EQUALITY [A]]
...
feature -- Properties (Relationship)
	...
	holds_ok (a, b: A; eq: EQ): BOOLEAN
			-- Do the properties verified within set theory hold for {STS_OBJECT_DEEP_EQUALITY}.holds?
		do
			check
