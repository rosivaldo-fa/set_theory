note
	description: "Test suite for {OBJECT_EQUALITY}"
	author: "Rosivaldo F Alves"
	date: "$Date$"
	revision: "$Revision$"

class
	OBJECT_EQUALITY_TESTS
...
feature -- Test routines (Relationship)
	...
	test_holds
			-- Test {OBJECT_EQUALITY}.holds.
		note
			testing: "covers/{OBJECT_EQUALITY}.holds"
	...
	test_holds_successively
			-- Test {OBJECT_EQUALITY}.holds_successively.
		note
			testing: "covers/{OBJECT_EQUALITY}.holds_successively"
		local
			eq: like equality_to_be_tested
...
feature {NONE} -- Factory (Element to be tested)
	...
	equality_to_be_tested: OBJECT_EQUALITY [detachable separate CHARACTER_REF]
			-- <Precursor>
		do
			create Result
		end
