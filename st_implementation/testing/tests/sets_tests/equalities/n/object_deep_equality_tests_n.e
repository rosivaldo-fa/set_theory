note
	description: "Test suite for {OBJECT_DEEP_EQUALITY_N}"
...
inherit
	OBJECT_DEEP_EQUALITY_TESTS [NATURAL, OBJECT_DEEP_EQUALITY_N]
		rename
...
feature -- Access
	...
	properties: STP_OBJECT_DEEP_EQUALITY_PROPERTIES [NATURAL, OBJECT_DEEP_EQUALITY_N];
	-- <Precursor>
