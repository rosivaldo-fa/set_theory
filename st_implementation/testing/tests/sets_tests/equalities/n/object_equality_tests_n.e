note
	description: "Test suite for {OBJECT_EQUALITY_N}"
...
inherit
	OBJECT_EQUALITY_TESTS [NATURAL, OBJECT_EQUALITY_N]
		rename
...
feature -- Access
	...
	properties: STP_OBJECT_EQUALITY_PROPERTIES [NATURAL, OBJECT_EQUALITY_N]
			-- <Precursor>
