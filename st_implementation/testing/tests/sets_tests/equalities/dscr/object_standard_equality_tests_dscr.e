note
	description: "Test suite for {STS_OBJECT_STANDARD_EQUALITY [detachable separate CHARACTER_REF]}"
...
inherit
	OBJECT_STANDARD_EQUALITY_TESTS [detachable separate CHARACTER_REF, STS_OBJECT_STANDARD_EQUALITY [detachable separate CHARACTER_REF]]
		rename
			...
			some_set_a as some_set_of_standard_objects_dscr,
			some_immediate_set_a as some_immediate_set_of_standard_objects_dscr
		redefine
			properties,
			test_all,
			test_holds,
...
feature -- Access
	...
	properties: EQUALITY_PROPERTIES [detachable separate CHARACTER_REF, STS_OBJECT_STANDARD_EQUALITY [detachable separate CHARACTER_REF]];
			-- <Precursor>
