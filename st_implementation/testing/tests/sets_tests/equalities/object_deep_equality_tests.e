...
feature -- Access
	...
	properties: STP_OBJECT_DEEP_EQUALITY_PROPERTIES [A, EQ]
			-- Object that checks the set-theory properties of {STS_OBJECT_DEEP_EQUALITY}
