note
	description: "Test suite for {OBJECT_DEEP_EQUALITY_DIR}"
...
inherit
	OBJECT_DEEP_EQUALITY_TESTS [detachable INTEGER_REF, OBJECT_DEEP_EQUALITY_DIR]
		rename
...
feature -- Access
	...
	properties: STP_OBJECT_DEEP_EQUALITY_PROPERTIES [detachable INTEGER_REF, OBJECT_DEEP_EQUALITY_DIR];
	-- <Precursor>
