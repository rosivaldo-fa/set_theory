...
feature -- Properties (Membership)
	...
	is_not_in_ok (l: STS_INTEGER_NUMBER; s: STS_SET [STS_INTEGER_NUMBER]): BOOLEAN
...
feature -- Properties (Comparison)
	...
	equals_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	unequals_ok (n, m: STS_INTEGER_NUMBER): BOOLEAN
	...
	is_less_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	is_less_equal_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	is_greater_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	is_greater_equal_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	min_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	max_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
...
feature -- Properties (Relationship)
	...
	divides_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
...
feature -- Properties (Operation)
	...
	plus_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	identity_ok (n: STS_INTEGER_NUMBER): BOOLEAN
	...
	minus_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	product_ok (n, m, l: STS_INTEGER_NUMBER): BOOLEAN
	...
	integer_quotient_ok (n, m: STS_INTEGER_NUMBER): BOOLEAN
	...
	integer_remainder_ok (n, m: STS_INTEGER_NUMBER): BOOLEAN
